''' this program can decrypt the  a message encoded with caeser chiper wihtout the shift count , it works better for the lng messages '''  
...
ciphertext = CiphertextMessage(code)
print('Decrytped message:', ciphertext.decrypt_message())
